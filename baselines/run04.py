...
def train(args, extra_args, game_name, method_name, tag):
    ...
    env = build_env(args, game_name, method_name, tag)
...
def build_env(args, game_name, method_name, tag):
    ...
    if env_type in {'atari', 'retro'}:
        if alg == 'deepq':
            logger_dir_path = 'test_logs_{}/{}/{}'.format(tag, game_name, method_name)
...
def main(args):
    ...
    model, env = train(args, extra_args, game_name, method, tag)
